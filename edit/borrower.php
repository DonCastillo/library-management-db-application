        ...
        <?php
            ...
            if( isset($_GET['id']) && $_GET['id'] )
            {
                ...
                if ($borrowerResult && $borrowerResult->num_rows > 0)
                {
                    ...
                    echo '        <input type="text" class="form-control" id="email" name="email" value="'.$borrowerRow['email'].'" maxlength="35" required>';
                    echo '    </div>';
                    echo '    <div class="form-group mb-4">';
                    echo '        <label for="phone" class="mb-2">Phone </label>';
                    echo '        <input type="text" class="form-control" id="phone" name="phone" value="'.$borrowerRow['phone'].'" maxlength="15" >';
                    echo '    </div>';
                    echo '    <div class="form-group mb-4">';
                    ...
                    echo '          <option value="'.$borrowerRow['prov'].'" selected>'.$borrowerRow['prov'].'</option>';
